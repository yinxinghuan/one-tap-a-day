...
export function useDailyTap() {
  ...
  const demoAvatars: OrbitUser[] = [
    { id: 'm', isSelf: true, initial: 'M' },          // self (no avatar url → initial)
    { id: 'a', initial: 'A', url: 'https://i.pravatar.cc/64?img=12' },
    { id: 'i', initial: 'I', url: 'https://i.pravatar.cc/64?img=33' },
    { id: 'j', initial: 'J', url: 'https://i.pravatar.cc/64?img=47' },
    { id: 'g', initial: 'G', url: 'https://i.pravatar.cc/64?img=5' },
    { id: 'b', initial: 'B', url: 'https://i.pravatar.cc/64?img=68' },
  ];
